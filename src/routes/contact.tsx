...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Visit & Book | Elven Beauty Hub" },
      {
        property: "og:description",
        content:
          "Shop 27, Nipost Shopping Complex, Sabo Yaba. Walk-ins welcome, appointments preferred — book now on WhatsApp.",
      },
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-3xl border border-border bg-card p-6 shadow-soft">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-ink text-cream">
                    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5z" />
                  ...
                  <a href={CONTACT.phoneHref} className="font-display mt-2 block text-lg text-ink transition-colors hover:text-gold-deep">
                ...
                <div className="rounded-3xl border border-border bg-card p-6 shadow-soft">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-ink/10 bg-beige text-ink">
                    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21s-7-6.22-7-11.5A7 7 0 0 1 12 3a7 7 0 0 1 7 6.5C19 14.78 12 21 12 21z" />
                  ...
                  <p className="font-display mt-2 text-lg leading-snug text-ink">{CONTACT.address}</p>
              ...
              <form onSubmit={onSubmit} className="mt-8 grid gap-5">
                <div className="grid gap-5 sm:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-[0.7rem] uppercase tracking-[0.18em] text-charcoal">
                      Full name *
                    </Label>
                    <Input
                      id="name"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-[0.7rem] uppercase tracking-[0.18em] text-charcoal">
                      Phone / WhatsApp *
                    </Label>
                    <Input
                      id="phone"
                ...
                <div className="space-y-2">
                  <Label htmlFor="service" className="text-[0.7rem] uppercase tracking-[0.18em] text-charcoal">
                ...
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-[0.7rem] uppercase tracking-[0.18em] text-charcoal">
                    Your message
                  </Label>
                  <Textarea
                    id="message"
            ...
            <div className="relative overflow-hidden rounded-4xl bg-noir px-8 py-16 text-center sm:px-14 sm:py-20">
              ...
              <div className="relative">
                ...
                <h3 className="font-display mx-auto mt-6 max-w-2xl text-[2rem] leading-[1.1] text-cream sm:text-5xl">
                  Ready when you are. <span className="text-gold-gradient italic">Tap to book.</span>
                </h3>
